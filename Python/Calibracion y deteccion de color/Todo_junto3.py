...
cv2.createTrackbar('X_ini', 'Mask', 327, ancho, nada)
cv2.createTrackbar('X_final', 'Mask', 350, ancho, nada)
cv2.createTrackbar('Y_ini', 'Mask', 48, alto, nada)
cv2.createTrackbar('Y_final', 'Mask', 72, alto, nada)
cv2.createTrackbar('Copia Desplazada', 'Mask', 136, alto, nada)
