...
def encontrar_puntob(img2,flag):
    ...
    #cv2.imshow()
        ...
        if(seg):
            tolerancia = 10
            x1 = p_blanco[0] - tolerancia*2
            x2 = p_blanco[0] + tolerancia*2
...
cv2.createTrackbar('Y_ini', 'Mask', 38, alto, nada)#38
cv2.createTrackbar('Y_final', 'Mask', 60, alto, nada)#60
cv2.createTrackbar('Copia Desplazada', 'Mask', 128, alto, nada)#128
