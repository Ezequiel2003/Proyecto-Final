 ...
 */
#ifndef RTW_HEADER_q_rotpen_mdl_h_
#define RTW_HEADER_q_rotpen_mdl_h_
#ifndef q_rotpen_mdl_COMMON_INCLUDES_
# define q_rotpen_mdl_COMMON_INCLUDES_
#include <math.h>
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* q_rotpen_mdl_COMMON_INCLUDES_ */

#include "q_rotpen_mdl_types.h"
...
#define q_rotpen_mdl_rtModel           RT_MODEL_q_rotpen_mdl
...
#define rtB                            q_rotpen_mdl_B
#define BlockIO                        BlockIO_q_rotpen_mdl
#define rtXdot                         q_rotpen_mdl_Xdot
#define StateDerivatives               StateDerivatives_q_rotpen_mdl
#define tXdis                          q_rotpen_mdl_Xdis
#define StateDisabled                  StateDisabled_q_rotpen_mdl
#define rtP                            q_rotpen_mdl_P
#define Parameters                     Parameters_q_rotpen_mdl
#define rtDWork                        q_rotpen_mdl_DWork
#define D_Work                         D_Work_q_rotpen_mdl

/* Parameters (auto storage) */
struct Parameters_q_rotpen_mdl_ {
  ...
  real_T uV_Value;                     /* Expression: 0
                                        ...
                                        */
  real_T DirectionConventionarmCCWwhenu0;/* Expression: -1
...
extern Parameters_q_rotpen_mdl q_rotpen_mdl_P;

/* Block signals (auto storage) */
extern BlockIO_q_rotpen_mdl q_rotpen_mdl_B;

/* Block states (auto storage) */
extern D_Work_q_rotpen_mdl q_rotpen_mdl_DWork;

/* Model entry point functions */
extern void q_rotpen_mdl_initialize(void);
extern void q_rotpen_mdl_output(void);
extern void q_rotpen_mdl_update(void);
extern void q_rotpen_mdl_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_q_rotpen_mdl *const q_rotpen_mdl_M;
 ...
 *
 * '<Root>' : 'q_rotpen_mdl'
 * '<S1>'   : 'q_rotpen_mdl/Powered by QuaRC'
 * '<S2>'   : 'q_rotpen_mdl/Radians to Degrees'
 * '<S3>'   : 'q_rotpen_mdl/Radians to Degrees1'
 * '<S4>'   : 'q_rotpen_mdl/SRV02-ET+ROTPEN-E'
 * '<S5>'   : 'q_rotpen_mdl/SRV02-ET+ROTPEN-E/Calculate Upright Angle'
 */
#endif                                 /* RTW_HEADER_q_rotpen_mdl_h_ */
