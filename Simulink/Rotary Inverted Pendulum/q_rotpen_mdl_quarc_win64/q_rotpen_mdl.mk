...
MODEL                = q_rotpen_mdl
MODULES              = q_rotpen_mdl_data.c q_rotpen_mdl_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = q_rotpen_mdl.mk
...
MODELLIB                  = q_rotpen_mdllib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = q_rotpen_mdl_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\CONTRO~1\Rotary\ROTARY~4
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\CONTRO~1\Rotary\ROTARY~4\Courseware\Controllers
