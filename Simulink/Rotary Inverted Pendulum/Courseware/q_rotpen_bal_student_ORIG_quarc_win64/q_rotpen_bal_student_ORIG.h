 ...
 */
#ifndef RTW_HEADER_q_rotpen_bal_student_ORIG_h_
#define RTW_HEADER_q_rotpen_bal_student_ORIG_h_
#ifndef q_rotpen_bal_student_ORIG_COMMON_INCLUDES_
# define q_rotpen_bal_student_ORIG_COMMON_INCLUDES_
#include <math.h>
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* q_rotpen_bal_student_ORIG_COMMON_INCLUDES_ */

#include "q_rotpen_bal_student_ORIG_types.h"
...
} StateDisabled_q_rotpen_bal_stud;
...
#define rtB                            q_rotpen_bal_student_ORIG_B
#define BlockIO                        BlockIO_q_rotpen_bal_student_OR
#define rtX                            q_rotpen_bal_student_ORIG_X
#define ContinuousStates               ContinuousStates_q_rotpen_bal_s
#define rtP                            q_rotpen_bal_student_ORIG_P
#define Parameters                     Parameters_q_rotpen_bal_student
#define rtDWork                        q_rotpen_bal_student_ORIG_DWork
#define D_Work                         D_Work_q_rotpen_bal_student_ORI

/* Parameters (auto storage) */
struct Parameters_q_rotpen_bal_student_ {
  ...
  real_T SignalGenerator_Frequency;    /* Expression: 0.05
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
  real_T Amplitudedeg_Gain;            /* Expression: 10
...
struct RT_MODEL_q_rotpen_bal_student_O {
  const char_T *path;
...
extern Parameters_q_rotpen_bal_student q_rotpen_bal_student_ORIG_P;

/* Block signals (auto storage) */
extern BlockIO_q_rotpen_bal_student_OR q_rotpen_bal_student_ORIG_B;

/* Continuous states (auto storage) */
extern ContinuousStates_q_rotpen_bal_s q_rotpen_bal_student_ORIG_X;

/* Block states (auto storage) */
extern D_Work_q_rotpen_bal_student_ORI q_rotpen_bal_student_ORIG_DWork;

/* Model entry point functions */
extern void q_rotpen_bal_student_ORIG_initialize(void);
extern void q_rotpen_bal_student_ORIG_output(void);
extern void q_rotpen_bal_student_ORIG_update(void);
extern void q_rotpen_bal_student_ORIG_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_q_rotpen_bal_student_O *const q_rotpen_bal_student_ORIG_M;
 ...
 *
 * '<Root>' : 'q_rotpen_bal_student_ORIG'
 * '<S1>'   : 'q_rotpen_bal_student_ORIG/Degrees to Radians'
 * '<S2>'   : 'q_rotpen_bal_student_ORIG/Enable Balance Control'
 * '<S3>'   : 'q_rotpen_bal_student_ORIG/Find State X'
 * '<S4>'   : 'q_rotpen_bal_student_ORIG/Powered by QuaRC'
 * '<S5>'   : 'q_rotpen_bal_student_ORIG/SRV02-ET+ROTPEN-E'
 * '<S6>'   : 'q_rotpen_bal_student_ORIG/Scopes'
 * '<S7>'   : 'q_rotpen_bal_student_ORIG/SRV02-ET+ROTPEN-E/Calculate Upright Angle'
 * '<S8>'   : 'q_rotpen_bal_student_ORIG/Scopes/alpha: rad to deg'
 * '<S9>'   : 'q_rotpen_bal_student_ORIG/Scopes/theta: rad to deg'
 */
#endif                                 /* RTW_HEADER_q_rotpen_bal_student_ORIG_h_ */
