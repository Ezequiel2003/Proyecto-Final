...
MODEL                = q_rotpen_bal_student_ORIG
MODULES              = q_rotpen_bal_student_ORIG_data.c q_rotpen_bal_student_ORIG_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = q_rotpen_bal_student_ORIG.mk
MATLAB_ROOT          = C:\Program Files\Matlab2012a
ALT_MATLAB_ROOT      = C:\PROGRA~1\MATLAB~1
MATLAB_BIN           = C:\Program Files\Matlab2012a\bin
...
NCSTATES             = 2
COMPUTER             = PCWIN64
BUILDARGS            =  GENERATE_REPORT=0 SHOW_TIMES=0 DEBUG=0 DEBUG_HEAP=0
MULTITASKING         = 0
EXT_MODE             = 1
...
MODELLIB                  = q_rotpen_bal_student_ORIGlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = q_rotpen_bal_student_ORIG_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\CONTRO~1\Rotary\ROTARY~4\COURSE~1
MATLAB_INCLUDES = $(MATLAB_INCLUDES);E:\CONTRO~1\Rotary\ROTARY~4\COURSE~1\Controllers
