 ...
 */
#ifndef RTW_HEADER_q_rotpen_bal_student00_h_
#define RTW_HEADER_q_rotpen_bal_student00_h_
#ifndef q_rotpen_bal_student00_COMMON_INCLUDES_
# define q_rotpen_bal_student00_COMMON_INCLUDES_
#include <math.h>
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* q_rotpen_bal_student00_COMMON_INCLUDES_ */

#include "q_rotpen_bal_student00_types.h"
...
#define q_rotpen_bal_student00_rtModel RT_MODEL_q_rotpen_bal_student00
...
} BlockIO_q_rotpen_bal_student00;
...
#define rtB                            q_rotpen_bal_student00_B
#define BlockIO                        BlockIO_q_rotpen_bal_student00
#define rtX                            q_rotpen_bal_student00_X
#define ContinuousStates               ContinuousStates_q_rotpen_bal_s
#define rtP                            q_rotpen_bal_student00_P
#define Parameters                     Parameters_q_rotpen_bal_student
#define rtDWork                        q_rotpen_bal_student00_DWork
#define D_Work                         D_Work_q_rotpen_bal_student00
...
struct RT_MODEL_q_rotpen_bal_student00 {
  const char_T *path;
...
extern Parameters_q_rotpen_bal_student q_rotpen_bal_student00_P;

/* Block signals (auto storage) */
extern BlockIO_q_rotpen_bal_student00 q_rotpen_bal_student00_B;

/* Continuous states (auto storage) */
extern ContinuousStates_q_rotpen_bal_s q_rotpen_bal_student00_X;

/* Block states (auto storage) */
extern D_Work_q_rotpen_bal_student00 q_rotpen_bal_student00_DWork;

/* Model entry point functions */
extern void q_rotpen_bal_student00_initialize(void);
extern void q_rotpen_bal_student00_output(void);
extern void q_rotpen_bal_student00_update(void);
extern void q_rotpen_bal_student00_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_q_rotpen_bal_student00 *const q_rotpen_bal_student00_M;
 ...
 *
 * '<Root>' : 'q_rotpen_bal_student00'
 * '<S1>'   : 'q_rotpen_bal_student00/Degrees to Radians'
 * '<S2>'   : 'q_rotpen_bal_student00/Enable Balance Control'
 * '<S3>'   : 'q_rotpen_bal_student00/Find State X'
 * '<S4>'   : 'q_rotpen_bal_student00/Powered by QuaRC'
 * '<S5>'   : 'q_rotpen_bal_student00/SRV02-ET+ROTPEN-E'
 * '<S6>'   : 'q_rotpen_bal_student00/Scopes'
 * '<S7>'   : 'q_rotpen_bal_student00/SRV02-ET+ROTPEN-E/Calculate Upright Angle'
 * '<S8>'   : 'q_rotpen_bal_student00/Scopes/alpha: rad to deg'
 * '<S9>'   : 'q_rotpen_bal_student00/Scopes/theta: rad to deg'
 */
#endif                                 /* RTW_HEADER_q_rotpen_bal_student00_h_ */
