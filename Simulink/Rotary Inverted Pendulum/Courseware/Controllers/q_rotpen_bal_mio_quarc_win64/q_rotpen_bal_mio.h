...
#ifndef RTW_HEADER_q_rotpen_bal_mio_h_
#define RTW_HEADER_q_rotpen_bal_mio_h_
#include <float.h>
#include <math.h>
#include <string.h>
#ifndef q_rotpen_bal_mio_COMMON_INCLUDES_
# define q_rotpen_bal_mio_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* q_rotpen_bal_mio_COMMON_INCLUDES_ */

#include "q_rotpen_bal_mio_types.h"
...
#define q_rotpen_bal_mio_rtModel       RT_MODEL_q_rotpen_bal_mio_T
...
typedef struct {
  ...
  real_T Gain;                         /* '<S8>/Gain' */
  real_T Gain_p[2];                    /* '<S9>/Gain' */
  uint8_T Compare;                     /* '<S2>/Compare' */
} B_q_rotpen_bal_mio_T;
...
#define rtB                            q_rotpen_bal_mio_B
#define BlockIO                        B_q_rotpen_bal_mio_T
#define rtX                            q_rotpen_bal_mio_X
#define ContinuousStates               X_q_rotpen_bal_mio_T
#define rtXdot                         q_rotpen_bal_mio_XDot
#define StateDerivatives               XDot_q_rotpen_bal_mio_T
#define tXdis                          q_rotpen_bal_mio_XDis
#define StateDisabled                  XDis_q_rotpen_bal_mio_T
#define rtP                            q_rotpen_bal_mio_P
#define Parameters                     P_q_rotpen_bal_mio_T
#define rtDWork                        q_rotpen_bal_mio_DW
#define D_Work                         DW_q_rotpen_bal_mio_T

/* Parameters (auto storage) */
struct P_q_rotpen_bal_mio_T_ {
...
struct tag_RTM_q_rotpen_bal_mio_T {
  const char_T *path;
...
extern P_q_rotpen_bal_mio_T q_rotpen_bal_mio_P;

/* Block signals (auto storage) */
extern B_q_rotpen_bal_mio_T q_rotpen_bal_mio_B;

/* Continuous states (auto storage) */
extern X_q_rotpen_bal_mio_T q_rotpen_bal_mio_X;

/* Block states (auto storage) */
extern DW_q_rotpen_bal_mio_T q_rotpen_bal_mio_DW;

/* Model entry point functions */
extern void q_rotpen_bal_mio_initialize(void);
extern void q_rotpen_bal_mio_output(void);
extern void q_rotpen_bal_mio_update(void);
extern void q_rotpen_bal_mio_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_rotpen_bal_mio_rtModel *q_rotpen_bal_mio(void);
...
extern RT_MODEL_q_rotpen_bal_mio_T *const q_rotpen_bal_mio_M;
 ...
 *
 * '<Root>' : 'q_rotpen_bal_mio'
 * '<S1>'   : 'q_rotpen_bal_mio/Degrees to Radians'
 * '<S2>'   : 'q_rotpen_bal_mio/Enable Balance Control'
 * '<S3>'   : 'q_rotpen_bal_mio/Find State X'
 * '<S4>'   : 'q_rotpen_bal_mio/Powered by QuaRC'
 * '<S5>'   : 'q_rotpen_bal_mio/SRV02-ET+ROTPEN-E'
 * '<S6>'   : 'q_rotpen_bal_mio/Scopes'
 * '<S7>'   : 'q_rotpen_bal_mio/SRV02-ET+ROTPEN-E/Calculate Upright Angle'
 * '<S8>'   : 'q_rotpen_bal_mio/Scopes/alpha: rad to deg'
 * '<S9>'   : 'q_rotpen_bal_mio/Scopes/theta: rad to deg'
 */
#endif                                 /* RTW_HEADER_q_rotpen_bal_mio_h_ */
