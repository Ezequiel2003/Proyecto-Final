...
Parameters_q_rotpen_swingup q_rotpen_swingup_P = {
  /*  Expression:  K
   * Referenced by: '<Root>/Control  Gain'
   */
  { -5.2611594041473984, 28.156796760038027, -2.7575720928684229,
    3.219026488196238 },
  0.53743441183271223,                 /* Expression: Kg*km
                                        * Referenced by: '<S8>/Back-EMF (V.s//rad)'
                                        */
  11.575230633223583,                  /* Expression: a_max
                                        * Referenced by: '<S12>/Motor Acceleration Limit'
                                        */
  -11.575230633223583,                 /* Expression: -a_max
                                        * Referenced by: '<S12>/Motor Acceleration Limit'
                                        */
  0.055486299999999995,                /* Expression: Mr*Lr
                                        * Referenced by: '<S8>/Acceleration to Torque'
                                        */
  7.7849277384560782,                  /* Expression: Rm / ( eta_g * Kg * eta_m * kt )
  ...
  1.0,                                 /* Expression: 1
                                        ...
                                        */
  0.20964877424999998,                 /* Expression: Mp*g*Lp/2
  ...
  62.831853071795862,                  /* Computed Parameter: HPFalpha_dotrads_D
                                        * Referenced by: '<S3>/HPF: alpha_dot (rad//s)'
                                        */
  0.00059936540072916657,              /* Expression: Jp/2
