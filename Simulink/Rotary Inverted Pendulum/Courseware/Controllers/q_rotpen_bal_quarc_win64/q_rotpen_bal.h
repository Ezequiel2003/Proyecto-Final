...
#ifndef RTW_HEADER_q_rotpen_bal_h_
#define RTW_HEADER_q_rotpen_bal_h_
#include <float.h>
#include <math.h>
#include <string.h>
#ifndef q_rotpen_bal_COMMON_INCLUDES_
# define q_rotpen_bal_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* q_rotpen_bal_COMMON_INCLUDES_ */

#include "q_rotpen_bal_types.h"
...
#define q_rotpen_bal_rtModel           RT_MODEL_q_rotpen_bal_T
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } alphadot_PWORK;                    /* '<S3>/alpha dot' */

  struct {
    void *LoggedData;
  } thetadot_PWORK;                    /* '<S3>/theta dot' */
...
#define rtB                            q_rotpen_bal_B
#define BlockIO                        B_q_rotpen_bal_T
#define rtX                            q_rotpen_bal_X
#define ContinuousStates               X_q_rotpen_bal_T
#define rtXdot                         q_rotpen_bal_XDot
#define StateDerivatives               XDot_q_rotpen_bal_T
#define tXdis                          q_rotpen_bal_XDis
#define StateDisabled                  XDis_q_rotpen_bal_T
#define rtP                            q_rotpen_bal_P
#define Parameters                     P_q_rotpen_bal_T
#define rtDWork                        q_rotpen_bal_DW
#define D_Work                         DW_q_rotpen_bal_T

/* Parameters (auto storage) */
struct P_q_rotpen_bal_T_ {
...
extern P_q_rotpen_bal_T q_rotpen_bal_P;

/* Block signals (auto storage) */
extern B_q_rotpen_bal_T q_rotpen_bal_B;

/* Continuous states (auto storage) */
extern X_q_rotpen_bal_T q_rotpen_bal_X;

/* Block states (auto storage) */
extern DW_q_rotpen_bal_T q_rotpen_bal_DW;

/* Model entry point functions */
extern void q_rotpen_bal_initialize(void);
extern void q_rotpen_bal_output(void);
extern void q_rotpen_bal_update(void);
extern void q_rotpen_bal_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_rotpen_bal_rtModel *q_rotpen_bal(void);
...
extern RT_MODEL_q_rotpen_bal_T *const q_rotpen_bal_M;
 ...
 *
 * '<Root>' : 'q_rotpen_bal'
 * '<S1>'   : 'q_rotpen_bal/Degrees to Radians'
 * '<S2>'   : 'q_rotpen_bal/Enable Balance Control'
 * '<S3>'   : 'q_rotpen_bal/Find State X'
 * '<S4>'   : 'q_rotpen_bal/Powered by QuaRC'
 * '<S5>'   : 'q_rotpen_bal/SRV02-ET+ROTPEN-E'
 * '<S6>'   : 'q_rotpen_bal/Scopes'
 * '<S7>'   : 'q_rotpen_bal/SRV02-ET+ROTPEN-E/Calculate Upright Angle'
 * '<S8>'   : 'q_rotpen_bal/Scopes/alpha: rad to deg'
 * '<S9>'   : 'q_rotpen_bal/Scopes/theta: rad to deg'
 */
#endif                                 /* RTW_HEADER_q_rotpen_bal_h_ */
