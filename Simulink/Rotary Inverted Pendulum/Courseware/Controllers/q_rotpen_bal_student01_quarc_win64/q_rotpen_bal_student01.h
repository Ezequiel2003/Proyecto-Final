 ...
 */
#ifndef RTW_HEADER_q_rotpen_bal_student01_h_
#define RTW_HEADER_q_rotpen_bal_student01_h_
#ifndef q_rotpen_bal_student01_COMMON_INCLUDES_
# define q_rotpen_bal_student01_COMMON_INCLUDES_
#include <math.h>
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* q_rotpen_bal_student01_COMMON_INCLUDES_ */

#include "q_rotpen_bal_student01_types.h"
...
#define q_rotpen_bal_student01_rtModel RT_MODEL_q_rotpen_bal_student01
...
} BlockIO_q_rotpen_bal_student01;
...
#define rtB                            q_rotpen_bal_student01_B
#define BlockIO                        BlockIO_q_rotpen_bal_student01
#define rtX                            q_rotpen_bal_student01_X
#define ContinuousStates               ContinuousStates_q_rotpen_bal_s
#define rtP                            q_rotpen_bal_student01_P
#define Parameters                     Parameters_q_rotpen_bal_student
#define rtDWork                        q_rotpen_bal_student01_DWork
#define D_Work                         D_Work_q_rotpen_bal_student01
...
struct RT_MODEL_q_rotpen_bal_student01 {
  const char_T *path;
...
extern Parameters_q_rotpen_bal_student q_rotpen_bal_student01_P;

/* Block signals (auto storage) */
extern BlockIO_q_rotpen_bal_student01 q_rotpen_bal_student01_B;

/* Continuous states (auto storage) */
extern ContinuousStates_q_rotpen_bal_s q_rotpen_bal_student01_X;

/* Block states (auto storage) */
extern D_Work_q_rotpen_bal_student01 q_rotpen_bal_student01_DWork;

/* Model entry point functions */
extern void q_rotpen_bal_student01_initialize(void);
extern void q_rotpen_bal_student01_output(void);
extern void q_rotpen_bal_student01_update(void);
extern void q_rotpen_bal_student01_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_q_rotpen_bal_student01 *const q_rotpen_bal_student01_M;
 ...
 *
 * '<Root>' : 'q_rotpen_bal_student01'
 * '<S1>'   : 'q_rotpen_bal_student01/Degrees to Radians'
 * '<S2>'   : 'q_rotpen_bal_student01/Enable Balance Control'
 * '<S3>'   : 'q_rotpen_bal_student01/Find State X'
 * '<S4>'   : 'q_rotpen_bal_student01/Powered by QuaRC'
 * '<S5>'   : 'q_rotpen_bal_student01/SRV02-ET+ROTPEN-E'
 * '<S6>'   : 'q_rotpen_bal_student01/Scopes'
 * '<S7>'   : 'q_rotpen_bal_student01/SRV02-ET+ROTPEN-E/Calculate Upright Angle'
 * '<S8>'   : 'q_rotpen_bal_student01/Scopes/alpha: rad to deg'
 * '<S9>'   : 'q_rotpen_bal_student01/Scopes/theta: rad to deg'
 */
#endif                                 /* RTW_HEADER_q_rotpen_bal_student01_h_ */
