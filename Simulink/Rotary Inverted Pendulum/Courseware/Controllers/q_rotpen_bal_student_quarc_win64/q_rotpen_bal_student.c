...
/* Real-time model */
RT_MODEL_q_rotpen_bal_student_T q_rotpen_bal_student_M_;
...
void q_rotpen_bal_student_output(void)
{
    ...
    /* S-Function Block: q_rotpen_bal_student/SRV02-ET+ROTPEN-E/HIL Read Encoder (hil_read_encoder_block) */
    {
      t_error result = hil_read_encoder
        (q_rotpen_bal_student_DW.HILInitialize_Card,
         ...
         &q_rotpen_bal_student_DW.HILReadEncoder_Buffer[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(q_rotpen_bal_student_M, _rt_error_message);
      } else {
        rtb_HILReadEncoder[0] = q_rotpen_bal_student_DW.HILReadEncoder_Buffer[0];
        rtb_HILReadEncoder[1] = q_rotpen_bal_student_DW.HILReadEncoder_Buffer[1];
      }
    }

    /* Gain: '<S5>/Encoder Calibration  (rad//count)' */
    q_rotpen_bal_student_B.EncoderCalibrationradcount[0] =
      q_rotpen_bal_student_P.K_ENC * rtb_HILReadEncoder[0];
    q_rotpen_bal_student_B.EncoderCalibrationradcount[1] =
      q_rotpen_bal_student_P.K_ENC * rtb_HILReadEncoder[1];
   ...
   */
  if (q_rotpen_bal_student_B.Compare == 0) {
  ...
  if (rtmIsMajorTimeStep(q_rotpen_bal_student_M)) {
    ...
    {
      t_error result;
      q_rotpen_bal_student_DW.HILWriteDigital_Buffer[0] =
        (q_rotpen_bal_student_P.EnableVoltPAQX2X4_Value[0] != 0);
      q_rotpen_bal_student_DW.HILWriteDigital_Buffer[1] =
        (q_rotpen_bal_student_P.EnableVoltPAQX2X4_Value[1] != 0);
      q_rotpen_bal_student_DW.HILWriteDigital_Buffer[2] =
        (q_rotpen_bal_student_P.EnableVoltPAQX2X4_Value[2] != 0);
      q_rotpen_bal_student_DW.HILWriteDigital_Buffer[3] =
        (q_rotpen_bal_student_P.EnableVoltPAQX2X4_Value[3] != 0);
      result = hil_write_digital(q_rotpen_bal_student_DW.HILInitialize_Card,
...
void q_rotpen_bal_student_initialize(void)
{
  ...
  /* S-Function Block: q_rotpen_bal_student/SRV02-ET+ROTPEN-E/HIL Initialize (hil_initialize_block) */
  {
    ...
    result = hil_open("q8_usb", "0", &q_rotpen_bal_student_DW.HILInitialize_Card);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(q_rotpen_bal_student_M, _rt_error_message);
    ...
    result = hil_set_card_specific_options
      (q_rotpen_bal_student_DW.HILInitialize_Card, "update_rate=normal", 19);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(q_rotpen_bal_student_M, _rt_error_message);
    ...
    result = hil_set_digital_directions
      (q_rotpen_bal_student_DW.HILInitialize_Card, NULL, 0U,
    ...
    if ((q_rotpen_bal_student_P.HILInitialize_DOStart && !is_switching) ||
      ...
      {
        int_T i1;
        boolean_T *dw_DOBits = &q_rotpen_bal_student_DW.HILInitialize_DOBits[0];
        for (i1=0; i1 < 8; i1++) {
      ...
      result = hil_write_digital(q_rotpen_bal_student_DW.HILInitialize_Card,
        ...
        &q_rotpen_bal_student_DW.HILInitialize_DOBits[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(q_rotpen_bal_student_M, _rt_error_message);
    ...
    if (q_rotpen_bal_student_P.HILInitialize_DOReset) {
      {
        int_T i1;
        int32_T *dw_DOStates = &q_rotpen_bal_student_DW.HILInitialize_DOStates[0];
        for (i1=0; i1 < 8; i1++) {
      ...
      result = hil_watchdog_set_digital_expiration_state
        (q_rotpen_bal_student_DW.HILInitialize_Card,
         q_rotpen_bal_student_P.HILInitialize_DOChannels, 8U, (const
          t_digital_state *) &q_rotpen_bal_student_DW.HILInitialize_DOStates[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(q_rotpen_bal_student_M, _rt_error_message);
    ...
    if ((q_rotpen_bal_student_P.HILInitialize_POPStart && !is_switching) ||
...

      {
        ...
        int32_T *dw_POModeValues =
          &q_rotpen_bal_student_DW.HILInitialize_POModeValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POModeValues[i1] = q_rotpen_bal_student_P.HILInitialize_POModes;
        }
      }

      result = hil_set_pwm_mode(q_rotpen_bal_student_DW.HILInitialize_Card,
...

      {
        ...
        for (i1=0; i1 < 8; i1++) {
          if (dw_POModeValues[i1] == PWM_DUTY_CYCLE_MODE || dw_POModeValues[i1] ==
            ...
            q_rotpen_bal_student_DW.HILInitialize_POSortedChans[num_duty_cycle_modes]
              = (p_HILInitialize_POChannels[i1]);
            q_rotpen_bal_student_DW.HILInitialize_POSortedFreqs[num_duty_cycle_modes]
              = q_rotpen_bal_student_P.HILInitialize_POFrequency;
            num_duty_cycle_modes++;
          } else {
            q_rotpen_bal_student_DW.HILInitialize_POSortedChans[7U -
              num_frequency_modes] = (p_HILInitialize_POChannels[i1]);
            q_rotpen_bal_student_DW.HILInitialize_POSortedFreqs[7U -
              num_frequency_modes] =
              q_rotpen_bal_student_P.HILInitialize_POFrequency;
            num_frequency_modes++;
          }
      ...
      if (num_duty_cycle_modes > 0) {
        result = hil_set_pwm_frequency
          (q_rotpen_bal_student_DW.HILInitialize_Card,
           &q_rotpen_bal_student_DW.HILInitialize_POSortedChans[0],
           num_duty_cycle_modes,
           &q_rotpen_bal_student_DW.HILInitialize_POSortedFreqs[0]);
        if (result < 0) {
          msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
            (_rt_error_message));
          rtmSetErrorStatus(q_rotpen_bal_student_M, _rt_error_message);
...

      {
        ...
        int32_T *dw_POAlignValues =
          &q_rotpen_bal_student_DW.HILInitialize_POAlignValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POAlignValues[i1] =
...

      {
        ...
        int32_T *dw_POPolarityVals =
          &q_rotpen_bal_student_DW.HILInitialize_POPolarityVals[0];
        for (i1=0; i1 < 8; i1++) {
      ...
      {
        int_T i1;
        real_T *dw_POValues = &q_rotpen_bal_student_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
          dw_POValues[i1] = q_rotpen_bal_student_P.HILInitialize_POTrailing;
        }
      }

      result = hil_set_pwm_deadband(q_rotpen_bal_student_DW.HILInitialize_Card,
        q_rotpen_bal_student_P.HILInitialize_POChannels, 8U,
        &q_rotpen_bal_student_DW.HILInitialize_POSortedFreqs[0],
        &q_rotpen_bal_student_DW.HILInitialize_POValues[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(q_rotpen_bal_student_M, _rt_error_message);
    ...
    if ((q_rotpen_bal_student_P.HILInitialize_POStart && !is_switching) ||
      ...
      result = hil_write_pwm(q_rotpen_bal_student_DW.HILInitialize_Card,
        q_rotpen_bal_student_P.HILInitialize_POChannels, 8U,
        &q_rotpen_bal_student_DW.HILInitialize_POValues[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
...
void q_rotpen_bal_student_terminate(void)
{
  ...
  /* S-Function Block: q_rotpen_bal_student/SRV02-ET+ROTPEN-E/HIL Initialize (hil_initialize_block) */
  {
    ...
    if (0
      ...
      result = hil_write(q_rotpen_bal_student_DW.HILInitialize_Card
...
RT_MODEL_q_rotpen_bal_student_T *q_rotpen_bal_student(void)
{
  ...
  /* External mode info */
  q_rotpen_bal_student_M->Sizes.checksums[0] = (350552568U);
  q_rotpen_bal_student_M->Sizes.checksums[1] = (2929658925U);
  q_rotpen_bal_student_M->Sizes.checksums[2] = (3453113124U);
  q_rotpen_bal_student_M->Sizes.checksums[3] = (3409332300U);
...

  {
    int32_T i;
    for (i = 0; i < 8; i++) {
      q_rotpen_bal_student_DW.HILInitialize_AIMinimums[i] = 0.0;
    }
  }

  {
    int32_T i;
    for (i = 0; i < 8; i++) {
      q_rotpen_bal_student_DW.HILInitialize_AIMaximums[i] = 0.0;
    }
  }

  {
    int32_T i;
    for (i = 0; i < 8; i++) {
      q_rotpen_bal_student_DW.HILInitialize_AOMinimums[i] = 0.0;
    }
  }

  {
    int32_T i;
    for (i = 0; i < 8; i++) {
      q_rotpen_bal_student_DW.HILInitialize_AOMaximums[i] = 0.0;
    }
  }

  {
    int32_T i;
    for (i = 0; i < 8; i++) {
      q_rotpen_bal_student_DW.HILInitialize_AOVoltages[i] = 0.0;
    }
  }

  {
    int32_T i;
    for (i = 0; i < 8; i++) {
      q_rotpen_bal_student_DW.HILInitialize_FilterFrequency[i] = 0.0;
    }
  }

  {
    int32_T i;
    for (i = 0; i < 8; i++) {
      q_rotpen_bal_student_DW.HILInitialize_POSortedFreqs[i] = 0.0;
    }
  }

  {
    int32_T i;
    for (i = 0; i < 8; i++) {
      q_rotpen_bal_student_DW.HILInitialize_POValues[i] = 0.0;
    }
  }
  ...
  q_rotpen_bal_student_M->Sizes.numPeriodicContStates = (0);/* Number of periodic continuous states */
