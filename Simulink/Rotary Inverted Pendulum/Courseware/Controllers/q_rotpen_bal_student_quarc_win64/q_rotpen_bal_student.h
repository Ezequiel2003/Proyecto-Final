...
#ifndef RTW_HEADER_q_rotpen_bal_student_h_
#define RTW_HEADER_q_rotpen_bal_student_h_
#include <float.h>
#include <math.h>
#include <string.h>
#ifndef q_rotpen_bal_student_COMMON_INCLUDES_
# define q_rotpen_bal_student_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* q_rotpen_bal_student_COMMON_INCLUDES_ */

#include "q_rotpen_bal_student_types.h"
...
#define q_rotpen_bal_student_rtModel   RT_MODEL_q_rotpen_bal_student_T
...
#define rtB                            q_rotpen_bal_student_B
#define BlockIO                        B_q_rotpen_bal_student_T
#define rtX                            q_rotpen_bal_student_X
#define ContinuousStates               X_q_rotpen_bal_student_T
#define rtXdot                         q_rotpen_bal_student_XDot
#define StateDerivatives               XDot_q_rotpen_bal_student_T
#define tXdis                          q_rotpen_bal_student_XDis
#define StateDisabled                  XDis_q_rotpen_bal_student_T
#define rtP                            q_rotpen_bal_student_P
#define Parameters                     P_q_rotpen_bal_student_T
#define rtDWork                        q_rotpen_bal_student_DW
#define D_Work                         DW_q_rotpen_bal_student_T

/* Parameters (auto storage) */
struct P_q_rotpen_bal_student_T_ {
  ...
  real_T u0V_Value;                    /* Expression: 0
                                        ...
                                        */
  real_T SignalGenerator_Amplitude;    /* Expression: 1.5
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
  real_T SignalGenerator_Frequency;    /* Expression: 0.01
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
...
struct tag_RTM_q_rotpen_bal_student_T {
  const char_T *path;
...
extern P_q_rotpen_bal_student_T q_rotpen_bal_student_P;

/* Block signals (auto storage) */
extern B_q_rotpen_bal_student_T q_rotpen_bal_student_B;

/* Continuous states (auto storage) */
extern X_q_rotpen_bal_student_T q_rotpen_bal_student_X;

/* Block states (auto storage) */
extern DW_q_rotpen_bal_student_T q_rotpen_bal_student_DW;

/* Model entry point functions */
extern void q_rotpen_bal_student_initialize(void);
extern void q_rotpen_bal_student_output(void);
extern void q_rotpen_bal_student_update(void);
extern void q_rotpen_bal_student_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_rotpen_bal_student_rtModel *q_rotpen_bal_student(void);
...
extern RT_MODEL_q_rotpen_bal_student_T *const q_rotpen_bal_student_M;
 ...
 *
 * '<Root>' : 'q_rotpen_bal_student'
 * '<S1>'   : 'q_rotpen_bal_student/Degrees to Radians'
 * '<S2>'   : 'q_rotpen_bal_student/Enable Balance Control'
 * '<S3>'   : 'q_rotpen_bal_student/Find State X'
 * '<S4>'   : 'q_rotpen_bal_student/Powered by QuaRC'
 * '<S5>'   : 'q_rotpen_bal_student/SRV02-ET+ROTPEN-E'
 * '<S6>'   : 'q_rotpen_bal_student/Scopes'
 * '<S7>'   : 'q_rotpen_bal_student/SRV02-ET+ROTPEN-E/Calculate Upright Angle'
 * '<S8>'   : 'q_rotpen_bal_student/Scopes/alpha: rad to deg'
 * '<S9>'   : 'q_rotpen_bal_student/Scopes/theta: rad to deg'
 */
#endif                                 /* RTW_HEADER_q_rotpen_bal_student_h_ */
