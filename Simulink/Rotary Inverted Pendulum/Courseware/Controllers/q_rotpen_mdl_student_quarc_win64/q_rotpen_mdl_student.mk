...
MODEL                = q_rotpen_mdl_student
MODULES              = q_rotpen_mdl_student_data.c q_rotpen_mdl_student_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             = q_rotpen_mdl_student.mk
...
NCSTATES             = 0
COMPUTER             = PCWIN64
BUILDARGS            =  ISPROTECTINGMODEL=NOTPROTECTING MAT_FILE=0 SHOW_TIMES=0 DEBUG=0 DEBUG_HEAP=0 OPTS="-DON_TARGET_WAIT_FOR_START=0"
MULTITASKING         = 0
EXT_MODE             = 1
...
MODELLIB                  = q_rotpen_mdl_studentlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = q_rotpen_mdl_student_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = E:\CONTRO~1\Rotary\ROTARY~4\COURSE~1\CONTRO~1
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\q_rotpen_mdl_student_quarc_win64
